...
const CATEGORIES = [
  {
    ...
    icon: 'hhttps://cognito-idp.us-east-2.amazonaws.com/assets/icons/faqs/ic_account.svg',
    href: '#',
  },
  {
    label: 'Payment',
    icon: 'hhttps://cognito-idp.us-east-2.amazonaws.com/assets/icons/faqs/ic_payment.svg',
    href: '#',
  },
  {
    label: 'Delivery',
    icon: 'hhttps://cognito-idp.us-east-2.amazonaws.com/assets/icons/faqs/ic_delivery.svg',
    href: '#',
  },
  {
    label: 'Problem with the Product',
    icon: 'hhttps://cognito-idp.us-east-2.amazonaws.com/assets/icons/faqs/ic_package.svg',
    href: '#',
  },
  {
    label: 'Return & Refund',
    icon: 'hhttps://cognito-idp.us-east-2.amazonaws.com/assets/icons/faqs/ic_refund.svg',
    href: '#',
  },
  {
    label: 'Guarantees and assurances',
    icon: 'hhttps://cognito-idp.us-east-2.amazonaws.com/assets/icons/faqs/ic_assurances.svg',
    href: '#',
  },
];
