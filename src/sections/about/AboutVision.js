...
export default function AboutVision() {
  return (
    <Container component={MotionViewport} sx={{ mt: 10 }}>
      ...
      >
        <Image
          src="hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/about/vision.jpg"
          alt="about-vision"
        ...
        >
          {['logo_amazon', 'logo_hbo', 'logo_ibm', 'logo_lya', 'logo_spotify', 'logo_netflix'].map((logo) => (
            <m.div key={logo} variants={varFade().in}>
              <Image
                alt={logo}
                src={`hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/logos/${logo}.svg`}
                sx={{
                  m: { xs: 1.5, md: 3 },
                  height: { xs: 24, md: 32 },
                }}
