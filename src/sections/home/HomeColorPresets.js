      ...
      <Container component={MotionViewport} sx={{ position: 'relative', textAlign: 'center' }}>
        ...
        <Box sx={{ position: 'relative' }}>
          <Image
            disabledEffect
            alt="grid"
            src="hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/theme-color/grid.png"
          />
          ...
          <Box sx={{ position: 'absolute', top: 0 }}>
            <m.div variants={varFade().inUp}>
              <Image
                disabledEffect
                alt="screen"
                src={`hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/theme-color/screen-${themeColorPresets}.png`}
              />
            </m.div>
          </Box>
            ...
            <m.div variants={varFade().inDown}>
              <m.div animate={{ y: [0, -15, 0] }} transition={{ duration: 8, repeat: Infinity }}>
                <Image
                  disabledEffect
                  alt="sidebar"
                  src={`hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/theme-color/block1-${themeColorPresets}.png`}
                />
              </m.div>
            </m.div>
          </Box>
            ...
            <m.div variants={varFade().inDown}>
              <m.div animate={{ y: [-5, 10, -5] }} transition={{ duration: 8, repeat: Infinity }}>
                <Image
                  disabledEffect
                  alt="sidebar"
                  src={`hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/theme-color/block2-${themeColorPresets}.png`}
                />
              </m.div>
            </m.div>
          </Box>
            ...
            <m.div variants={varFade().inDown}>
              <m.div animate={{ y: [-25, 5, -25] }} transition={{ duration: 10, repeat: Infinity }}>
                <Image
                  disabledEffect
                  alt="sidebar"
                  src={`hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/theme-color/sidebar-${themeColorPresets}.png`}
                />
              </m.div>
            </m.div>
          </Box>
