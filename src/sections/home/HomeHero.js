  ...
  return (
    <MotionContainer>
      <RootStyle>
        ...
        <HeroImgStyle
          alt="hero"
          src="hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/hero.png"
              ...
              <m.div variants={varFade().inRight}>
                <TextIconLabel
                  icon={
                    <Image
                      alt="sketch icon"
                      src="hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/ic_sketch_small.svg"
              ...
              <m.div variants={varFade().inRight}>
                <TextIconLabel
                  icon={
                    <Image
                      alt="sketch icon"
                      src="hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/ic_figma_small.svg"
                      sx={{ width: 20, height: 20, mr: 1 }}
                    />
                  }
                  value={
              ...
              <Stack direction="row" spacing={1.5} justifyContent={{ xs: 'center', md: 'flex-start' }}>
                {['ic_sketch', 'ic_figma', 'ic_js', 'ic_ts', 'ic_nextjs'].map((resource) => (
                  <m.img
                    ...
                    src={`hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/${resource}.svg`}
                  />
                ))}
              </Stack>
            </Stack>
