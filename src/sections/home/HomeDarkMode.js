    ...
    <RootStyle>
      <Container component={MotionViewport} sx={{ position: 'relative' }}>
        <Image
          ...
          disabledEffect
          alt="image shape"
          src="hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/shape.svg"
          sx={{
            top: 0,
            right: 0,
            bottom: 0,
        ...
        <Grid container spacing={5} direction="row-reverse" justifyContent="space-between">
          ...
          <Grid item xs={12} md={7} sx={{ position: 'relative' }}>
            <m.div variants={varFade().inUp}>
              <Image
                alt="light mode"
                src="hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/lightmode.png"
              />
            </m.div>

            <Box component={m.div} variants={varFade().inDown} sx={{ top: 0, left: 0, position: 'absolute' }}>
              <Image alt="dark mode" src="hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/darkmode.png" />
            </Box>
          </Grid>
        </Grid>
      </Container>
