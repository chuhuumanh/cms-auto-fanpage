...
const IMG = [...Array(10)].map(
  (_, index) => `hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/clean-${index + 1}.png`
);
          ...
          {IMG.map((_, index) => (
            ...
            >
              <Image
                ...
                visibleByDefault
                alt={`clean-${index + 1}`}
                src={`hhttps://cognito-idp.us-east-2.amazonaws.com/assets/images/home/clean-${index + 1}.png`}
              />
            </Box>
          ))}
        </Box>
